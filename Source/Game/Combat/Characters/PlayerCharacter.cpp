...
{
	actions.push_back(std::make_shared<MeleeAttack>("Teleporting Sword (IO)", 9, 3, 3, "Data/Sprites/UI/Icons/Icon Teleporting Sword.png"));
	actions.push_back(std::make_shared<MeleeAttack>("Standard Punch", 5, 1, 2, "Data/Sprites/UI/Icons/Icon Standard Punch.png"));
	actions.push_back(std::make_shared<GunAttack>("Blubberbus (Curse of the Corsair)", 4, 2, 1, 1, 2, "Data/Sprites/UI/Icons/Icon Blubberbus.png"));
